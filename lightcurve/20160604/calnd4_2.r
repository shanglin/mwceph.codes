rdir = '~/Work/mega/mwceph/lightcurve/20160604/rawlcs/'
outdir = '~/Work/mega/mwceph/lightcurve/20160604/calnd4/'

f.exp = '~/Work/mega/mwceph/lightcurve/20160604/exptimes/exps.dat'
...
f.eps = paste0(outdir,'nd4factor_2.eps')
setEPS()
...
yopn = y[idx]
eopn = e[idx] 
plot(xsol,ysol,pch = 19, cex=0.5, xlab='Instrumental H (mag)', ylab='ND4 Extinction (mag)',col=col.pnt, xlim=c(9.2,11.9),ylim=c(7.9,9.45))
