...
yopn = y[idx]
eopn = e[idx] 
plot(xsol,ysol,pch = 19, cex=0.5, xlab='Instrumental H (mag)', ylab='ND4 Attenuation (mag)',col=col.pnt, xlim=c(9.6,11.9),ylim=c(8.9,9.5), cex.lab=1.5, cex.axis=1.5)
