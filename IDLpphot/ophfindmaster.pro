...
;  Wenlong, 2014/12/05
;-
pro ophfindmaster,f_fit,ophfind_sigma,keep_log=keep_log
!quiet = 1
...
ophfind_bad = where(ophfind_a gt 1e19,complement = ophfind_good)
ophfind_s = ophfind_a
ophfind_s(ophfind_bad) = median(ophfind_a)
...
ophfind_fwhms = findgen(50)/10 + 1.0
id_start = 0
