pro ophfindnd,f_fit,ophfind_sigma
!quiet = 1
...
; 1. Fix bad pixels (-32767) using iraf
...
for i_ophfind_coo=0,n_elements(ophfind_coo.x)-1 do begin
   if (ophfind_coo[i_ophfind_coo].x gt 100 and ophfind_coo[i_ophfind_coo].x lt 400 $
       and ophfind_coo[i_ophfind_coo].y gt 100 and ophfind_coo[i_ophfind_coo].y lt 400) then begin
